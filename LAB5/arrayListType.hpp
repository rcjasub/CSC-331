...
public:
   ...
   // friend bool seqSearchType<elemType>::isItemAtEqual(int location, const elemType& item) const;
   // friend int seqSearchType<elemType>::print() const;
   // friend int seqSearchType<elemType>::seqSearch(const elemType&);
